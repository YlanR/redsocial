...
export const Sidebar = () => {
    ...
    const savePublication = async(e) => {
        ...
        // Hacer reques para guardar en bbdd
        ...
        if(data.status == "success" && fileInput.files[0] ){
            ...
            const uploadRequest = await fetch(Global.url + "publication/upload/"+ data.publicationStorage._id, {
                method: "POST",
                body: formData,
                 headers: {
                    "Authorization": token
    ...
    <aside className="layout__aside">
            ...
            <div className="aside__container">
                ...
                <div className="aside__container-form">
                    ...
                    {stored == "stored" ? <strong className='alert alert-success'> Publicado correctamente !!</strong> : ""}
